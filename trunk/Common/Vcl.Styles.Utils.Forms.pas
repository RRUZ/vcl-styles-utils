...
{$IFEND}
  ...
  // don't remove this - the WM_NCCREATE  message which set the value of this variable (FUpdateRegion) is not intercepeted because occurs before of the WM_CREATE  message
  // and this message (WM_CREATE) is used in the WH_CALLWNDPROC hook
  //FUpdateRegion := True;
end;
...
begin
  ...
  begin
    ...
    if not StyleServices.GetElementContentRect(0, LDetails, CaptionRect, Result)
    then
      Result := Rect(0, 0, 0, 0);
  end;
end;
