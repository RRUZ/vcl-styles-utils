...
type
  ...
  public
    ...
    class procedure SaveSettings(const FileName: String; Elements: TVCLStylesElements; FilterType: TVCLStylesFilter;
      Filters: TObjectList<TBitmapFilter>);
    class procedure LoadSettings(const FileName: String; var Elements: TVCLStylesElements;
      var FilterType: TVCLStylesFilter; Filters: TObjectList<TBitmapFilter>);
...
class procedure TVclStylesUtils.SaveSettings(const FileName: String; Elements: TVCLStylesElements;
  FilterType: TVCLStylesFilter; Filters: TObjectList<TBitmapFilter>);
var
  Doc: IXMLDocument;
...
class procedure TVclStylesUtils.LoadSettings(const FileName: String; var Elements: TVCLStylesElements;
  var FilterType: TVCLStylesFilter; Filters: TObjectList<TBitmapFilter>);
var
  Doc: IXMLDocument;
  RootNode, ChildNode, oNode: IXMLNode;
